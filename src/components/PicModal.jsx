...
export default function PicModal({ show, setShow, handlePhotoUpload }) {
  ...
  const cropImg = useCallback(() => {
    const croppedImage = cropperRef.current.cropper.getCroppedCanvas().toDataURL("image/jpeg");
    handlePhotoUpload(croppedImage);
  }, [handlePhotoUpload]);
